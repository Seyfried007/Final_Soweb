...
public class TokenUtils {
    private final static String SECRET = "4qhq8LrEBfYcaRHxhdb9zURb2rf8e7Ud";
    private final static Long VALIDITY_SECONDS = 1500L;

    public static String createToken(String nombre, String correo) {
        long expirationTime = VALIDITY_SECONDS * 1000;
